...
var IDIDGAME_Loop = (function (pub, undefined) {
    ...
    init = function () {
        ...
        pub.buttonRefresh = document.getElementById("button_go");
        pub.selectScale = document.getElementById("select_scale")
        pub.inputFade = document.getElementById("input_fade");

        pub.buttonRefresh.addEventListener("mousedown", pub.refresh);
