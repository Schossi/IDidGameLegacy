...
var IDIDGAME_Water = (function (pub, undefined) {
    ...
    init = function () {
        ...
        pub.canvas_main.addEventListener('mousedown', pub.mouseDown);
        pub.canvas_main.addEventListener('mouseup', pub.mouseUp);
        pub.canvas_main.addEventListener('mousemove', pub.mouseMove);
        pub.canvas_main.addEventListener('mousewheel', pub.mouseWheel);
        pub.canvas_main.addEventListener('contextmenu', pub.contextMenu);


        pub.Highscore.initScore();

        pub.toCall = [];

        pub.backContextsInitialized = false;

        pub.MainContext.init(pub.contextMain);
        pub.SoundSliderContext.init(pub.contextMain);
        pub.UIContext.init(pub.contextMain);
        pub.SkyContext.init(pub.contextMain);
    ...
    loadMedia = function () {
        ...
        pub.spriteMain.src = "Images/Fire.png";
        pub.totalMedia += 1;
    };
    mainLoaded = function () {
        pub.loadedMedia += 1;
    ...
    loop = function () {
        ...
        if (pub.loadedMedia >= pub.totalMedia && pub.isIntegrationLoaded()) {
            ...
            if (!pub.backContextsInitialized) {
                pub.backContextsInitialized = true;
                pub.BackContext.init(pub.contextMain);
                pub.BackContext2.init(pub.contextMain);
                pub.BackContext3.init(pub.contextMain);

            }

            pub.BackContext.work();
            pub.BackContext2.work();
            pub.BackContext3.work();
