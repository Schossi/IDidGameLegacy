...
class PathHorizontal extends PolymerElement {
  ...
  @observable WinCondition instanceCondition;
  @observable String instanceScoreText = "";
...
class WinCondition extends Observable {
