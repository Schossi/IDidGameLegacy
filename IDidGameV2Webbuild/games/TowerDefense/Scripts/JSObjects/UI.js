var IDIDGAME_TowerDefense = (function (pub, undefined) {
    ...
    pub.TextButton.initButton = function (_posX, _posY,_width,_height, _text, _action) {
        ...
        this.text.initText(_posX + _width / 2, _posY + _height/2, true, _text, _height - 10, "White", 2);
    ...
    pub.DnDButton.onMouseClick = function () {
        ...
        return function () {
            ...
            if (that.positionValid) {
                ...
                smoke.init(t.centerX, t.centerY, 2, 10, 30);

                pub.sound.build.request();
            }
        };
    };
    Object.defineProperty(pub.DnDButton, "active", {
        ...
        set: function (value) {
            ...
            if (this.iactive != value) {
                if (value) {
                    pub.sound.dndDown.request();
                } else {
                    pub.sound.dndUp.request();
                }
            }
    ...
    pub.AngleButton.initButton = function (_posX,_posY,_text,_onAngleChanged) {
        ...
        this.text = RSTools.createObject(pub.DrawableText);
        this.text.initText(this.posX + 15, this.posY - 5, true, _text, 10, "White");
    ...
    pub.SliderButton.initButton = function (_posX, _posY,_value, _text, _onValueChanged,_layer) {
        ...
        this.text = RSTools.createObject(pub.DrawableText);
        this.text.initText(this.posX -30, this.posY +10, true, _text, 12, "Black",2);
