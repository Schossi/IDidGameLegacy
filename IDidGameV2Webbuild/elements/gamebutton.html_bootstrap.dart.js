...
["app_bootstrap", "gamebutton.html_bootstrap.dart", , E, {
  "^": "",
  main: [function() {
    var t1, t2, t3;
    t1 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_clicked, new E.main_closure(), C.Symbol_description, new E.main_closure0(), C.Symbol_icon, new E.main_closure1(), C.Symbol_name, new E.main_closure2(), C.Symbol_path, new E.main_closure3()], null, null);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_description, new E.main_closure4(), C.Symbol_icon, new E.main_closure5(), C.Symbol_name, new E.main_closure6(), C.Symbol_path, new E.main_closure7()], null, null);
    t3 = P.LinkedHashMap_LinkedHashMap$_literal([C.Type_uLc, C.Type_GNh, C.Type_GNh, C.Type_I2I], null, null);
    t2 = O.StaticConfiguration$(false, P.LinkedHashMap_LinkedHashMap$_literal([C.Type_uLc, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_description, C.Declaration_3ls, C.Symbol_icon, C.Declaration_ZCw, C.Symbol_name, C.Declaration_oyU, C.Symbol_path, C.Declaration_aJC], null, null)], null, null), t1, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_clicked, "clicked", C.Symbol_description, "description", C.Symbol_icon, "icon", C.Symbol_name, "name", C.Symbol_path, "path"], null, null), t3, t2, null);
    ...
    new F.LogInjector(null, null).injectLogsFromUrl$1("gamebutton.html._buildLogs");
    $.initializers = [new E.main_closure8()];
    $.deployMode = true;
  ...
  main_closure8: {
    "^": "Closure:40;",
    call$0: function() {
      $.get$_typesByName().$indexSet(0, "game-button", C.Type_uLc);
      H.interceptedTypeCast(J.$index$asx($.get$context(), "Polymer"), "$isJsFunction").apply$1(["game-button"]);
      return;
    }
  }
},
...
["", "gamebutton.dart", , R, {
  "^": "",
  GameButton: {
    "^": "PolymerElement_ChangeNotifier;_gamebutton$__$name,_gamebutton$__$path,_gamebutton$__$icon,_gamebutton$__$description,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$name: function(receiver) {
      return receiver._gamebutton$__$name;
    },
    set$name: function(receiver, value) {
      receiver._gamebutton$__$name = this.notifyPropertyChange$3(receiver, C.Symbol_name, receiver._gamebutton$__$name, value);
    },
    get$path: function(receiver) {
      return receiver._gamebutton$__$path;
    },
    set$path: function(receiver, value) {
      receiver._gamebutton$__$path = this.notifyPropertyChange$3(receiver, C.Symbol_path, receiver._gamebutton$__$path, value);
    },
    get$icon: function(receiver) {
      return receiver._gamebutton$__$icon;
    },
    set$icon: function(receiver, value) {
      receiver._gamebutton$__$icon = this.notifyPropertyChange$3(receiver, C.Symbol_icon, receiver._gamebutton$__$icon, value);
    },
    get$description: function(receiver) {
      return receiver._gamebutton$__$description;
    },
    set$description: function(receiver, value) {
      receiver._gamebutton$__$description = this.notifyPropertyChange$3(receiver, C.Symbol_description, receiver._gamebutton$__$description, value);
    },
    clicked$0: [function(receiver) {
      window.location.href = "/games/" + H.S(receiver._gamebutton$__$path) + "/Game.html";
    }, "call$0", "get$clicked", 0, 0, 13]
  },
...
J.get$clicked$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$clicked(receiver);
};
...
C.Declaration_3ls = new A.Declaration(C.Symbol_description, C.DeclarationKind_1, false, C.Type_Ejg, false, C.List_bTJ);
C.Symbol_icon = new H.Symbol0("icon");
C.Declaration_ZCw = new A.Declaration(C.Symbol_icon, C.DeclarationKind_1, false, C.Type_Ejg, false, C.List_bTJ);
C.Symbol_path = new H.Symbol0("path");
C.Declaration_aJC = new A.Declaration(C.Symbol_path, C.DeclarationKind_1, false, C.Type_Ejg, false, C.List_bTJ);
C.Symbol_name = new H.Symbol0("name");
C.Declaration_oyU = new A.Declaration(C.Symbol_name, C.DeclarationKind_1, false, C.Type_Ejg, false, C.List_bTJ);
...
C.Symbol_clicked = new H.Symbol0("clicked");
...
C.Type_uLc = H.createRuntimeType('GameButton');
...
//# sourceMappingURL=gamebutton.html_bootstrap.dart.js.map
