...
["app_bootstrap", "signbig.html_bootstrap.dart", , E, {
  "^": "",
  main: [function() {
    var t1, t2, t3;
    t1 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_title, new E.main_closure()], null, null);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_title, new E.main_closure0()], null, null);
    t3 = P.LinkedHashMap_LinkedHashMap$_literal([C.Type_Feh, C.Type_GNh, C.Type_GNh, C.Type_I2I], null, null);
    t2 = O.StaticConfiguration$(false, P.LinkedHashMap_LinkedHashMap$_literal([C.Type_Feh, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_title, C.Declaration_IqA], null, null)], null, null), t1, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_title, "title"], null, null), t3, t2, null);
    ...
    new F.LogInjector(null, null).injectLogsFromUrl$1("signbig.html._buildLogs");
  ...
  main_closure1: {
    "^": "Closure:40;",
    call$0: function() {
      $.get$_typesByName().$indexSet(0, "sign-big", C.Type_Feh);
      H.interceptedTypeCast(J.$index$asx($.get$context(), "Polymer"), "$isJsFunction").apply$1(["sign-big"]);
      return;
    }
  }
},
...
C.Type_Feh = H.createRuntimeType('SignBig');
...
//# sourceMappingURL=signbig.html_bootstrap.dart.js.map
