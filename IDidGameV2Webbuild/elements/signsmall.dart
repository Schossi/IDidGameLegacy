...
class SignSmall extends PolymerElement with ChangeNotifier  {
  @reflectable @published String get text => __$text; String __$text = "init"; @reflectable set text(String value) { __$text = notifyPropertyChange(#text, __$text, value); }
