...
["app_bootstrap", "idgheader.html_bootstrap.dart", , E, {
  "^": "",
  main: [function() {
    var t1, t2, t3;
    t1 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_subtitle, new E.main_closure(), C.Symbol_title, new E.main_closure0(), C.Symbol_type, new E.main_closure1()], null, null);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_subtitle, new E.main_closure2(), C.Symbol_title, new E.main_closure3(), C.Symbol_type, new E.main_closure4()], null, null);
    t3 = P.LinkedHashMap_LinkedHashMap$_literal([C.Type_gkc, C.Type_GNh, C.Type_GNh, C.Type_I2I], null, null);
    t2 = O.StaticConfiguration$(false, P.LinkedHashMap_LinkedHashMap$_literal([C.Type_gkc, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_subtitle, C.Declaration_Aec, C.Symbol_title, C.Declaration_IqA, C.Symbol_type, C.Declaration_2Vk], null, null)], null, null), t1, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_subtitle, "subtitle", C.Symbol_title, "title", C.Symbol_type, "type"], null, null), t3, t2, null);
    ...
    new F.LogInjector(null, null).injectLogsFromUrl$1("idgheader.html._buildLogs");
    $.initializers = [new E.main_closure5()];
    $.deployMode = true;
  ...
  main_closure5: {
    "^": "Closure:40;",
    call$0: function() {
      $.get$_typesByName().$indexSet(0, "idg-header", C.Type_gkc);
      H.interceptedTypeCast(J.$index$asx($.get$context(), "Polymer"), "$isJsFunction").apply$1(["idg-header"]);
      return;
    }
  }
},
...
C.Symbol_subtitle = new H.Symbol0("subtitle");
...
//# sourceMappingURL=idgheader.html_bootstrap.dart.js.map
